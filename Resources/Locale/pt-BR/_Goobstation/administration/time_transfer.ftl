...
time-transfer-panel-warning-no-player =jogador não selected
time-transfer-panel-warning-no-job =papel não selected
time-transfer-panel-warning-group-no-time =grupo tempo é vazio
...
time-transfer-panel-search-placeholder = Pesquisar cargos
...
time-transfer-panel-no-player-database-message =jogador não fundar em banco de dados

# Please change it if you really-really need to do it
time-transfer-panel-author =fez por BombasterDS para Goobstation
