...
health-analyzer-window-entity-unrevivable-text = [color=red]Composição corporal única detectada! O paciente não pode ser reanimado por meios normais![/color]

health-analyzer-window-entity-bleeding-text = [color=red]O paciente está sangrando![/color]
