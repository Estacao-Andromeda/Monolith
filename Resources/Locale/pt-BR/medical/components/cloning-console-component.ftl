...
cloning-console-window-scanner-details-label = Status do Escaner Genético

cloning-console-window-pod-details-label = Status da Cápsula de Clonagem

cloning-console-window-no-scanner-detected-label = Conecte um escaner genético com uma multitool ou configurador de rede.

cloning-console-window-no-clone-pod-detected-label = Conecte uma cápsula de clonagem com uma multitool ou configurador de rede.

cloning-console-window-scanner-far-label = Escaner Genético Muito Distante
...
cloning-console-component-msg-scanner-occupant-alive = Não Pronto: Ocupante do Escaner Está Vivo

cloning-console-component-msg-already-alive = Não Pronto: Conflito Metafísico

cloning-console-component-msg-occupied = Não Pronto: A Cápsula Já Contém Um Clone

cloning-console-component-msg-already-cloning = Não Pronto: Conflito na Rede de Cápsulas
...
cloning-console-cellular-warning = AVISO: PONTUAÇÃO DE CONFIANÇA GENESCK É {$percent}%. A CLONAGEM PODE TER RESULTADOS INESPERADOS.
