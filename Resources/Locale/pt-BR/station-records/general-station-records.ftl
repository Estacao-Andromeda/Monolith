...
general-station-record-console-no-record-found = Nenhum registo foi encontrado para a pessoa selecionada.
...
general-station-record-for-filter-line-placeholder = Insira texto e pressione "Enter"
