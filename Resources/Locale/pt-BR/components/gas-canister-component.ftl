comp-gas-canister-ui-canister-status = Status do Cilindro
comp-gas-canister-ui-canister-relabel = Relabelar
comp-gas-canister-ui-canister-pressure = Pressão do Cilindro:
