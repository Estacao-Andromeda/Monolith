...
research-console-menu-title = Console P&D
...
research-console-unlock-technology-radio-broadcast = Desbloqueado [bold]{$technology}[/bold] para [bold]{$amount}[/bold] pesquisas por [bold]{$approver}[/bold].
