...
station-beacon-hop= RH

station-beacon-security= Segurança
station-beacon-brig= Brigada
station-beacon-brig-med= Médico da Brigada
station-beacon-warden= Carcereiro
station-beacon-hos= Chefe de Segurança
station-beacon-armory= Arsenal
station-beacon-perma-brig= Brigada Permanente
station-beacon-detective= Detetive
station-beacon-courtroom= Tribunal
station-beacon-law= Escritório de Lei
station-beacon-security-checkpoint= Posto de Controle

station-beacon-medical= Médico
station-beacon-medbay= Enfermaria
station-beacon-chemistry= Química
station-beacon-cryonics= Criópods
station-beacon-cmo= Diretor Médico
...
station-beacon-ame= GTR
station-beacon-solars= Solares
station-beacon-gravgen= GravGen
station-beacon-pa= Controle de PA
station-beacon-smes= SMES - Acumulador
station-beacon-telecoms= Telecomunicações
station-beacon-atmos= Atmós
station-beacon-teg= GTE - Gerador Termoelétrico
station-beacon-tech-vault= Cofre Tecnológico
station-beacon-anchor= Âncora

station-beacon-service= Serviços
station-beacon-kitchen= Cozinha
station-beacon-bar= Bar e Ambientes
