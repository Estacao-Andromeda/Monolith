...
comp-climbable-user-climbs-other  = {CAPITALIZE(THE($user))} pula em {THE($climbable)}!
...
comp-climbable-cant-reach = Você não pode alcançar lá!
...
comp-climbable-target-cant-climb = {CAPITALIZE(THE($moved-user))} não pode ir lá!
