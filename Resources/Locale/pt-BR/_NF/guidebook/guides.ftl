...
guide-entry-hiring = Contratação de Tripulação

guide-entry-expeditions = Expedições

guide-entry-sector-topology = Topologia do Setor
...
guide-entry-expedition-silicons = Silícios Descontrolados
...
guide-entry-frontier-rule-3 = 3. Escalação
