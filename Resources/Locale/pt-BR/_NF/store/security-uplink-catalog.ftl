...
uplink-security-hardsuit-desc = O traje padrão TSFMC à prova de espaço para patrulha. Esta variante bronze tem marcações de patente soldado.
...
uplink-security-techfab-desc = Um circuito impresso para um Techfab TSFMC. Permite a produção de munição, pentes, armas e numerosos outros utilitários. Usa recursos brutos. Pode ser atualizado.
