...
pirate-contraband-price-gun-pricing-result-none = O Skizzit não tem uma entrada para {THE($object)}.

medical-price-gun-pricing-result = O dispositivo afirma que {THE($object)} tem uma recompensa aberta de {$price}.
medical-price-gun-verb-text = Verificar recompensa
medical-price-gun-verb-message = Verificar recompensas em {THE($object)}.
medical-price-gun-pricing-result-none = O dispositivo afirma que {THE($object)} não tem recompensa.
