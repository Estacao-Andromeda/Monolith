...
seeds-spesos-display-name = árvores de speso

seeds-pear-name = pera

seeds-pear-display-name = pereiras
...
botany-seed-jar-name = pote de {$seedName} {$seedNoun}

seeds-lemoon-display-name = limeiros
