...
revenant-soul-begin-harvest = {CAPITALIZE(THE($target))} sobe repentinamente no ar, a pele de {POSS-ADJ($target)} tornando-se cinza-ardósia.
revenant-soul-finish-harvest = {CAPITALIZE(THE($target))} desaba no chão!
