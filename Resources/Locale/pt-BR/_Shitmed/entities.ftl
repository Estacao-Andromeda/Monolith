...
ent-OrganAnimalBrain = cérebro animal
    .desc = Tão inteligente, tão apatista.
...
ent-OrganGoliathHeart = coração de golias

ent-OrganLaserEyes = olhos laser de raptr

ent-OrganSpaceAnimalHeart = coração animal espacial

ent-OrganSpaceAnimalLungs = pulmões animais espaciais

# From: _Shitmed/Body/Organs/cybernetic.yml

ent-BasicCyberneticEyes = olhos cibernéticos
    .desc = Um par de olhos cibernéticos que melhoram sua visão e protegem contra danos nos olhos.

ent-MedicalCyberneticEyes = olhos cibernéticos diagnósticos
...
ent-OrganFelinidEars = orelhas de gato
    .desc = Segurar estas pode ser potencialmente contagioso.

ent-OrganFelinidTail = cauda de gato
    .desc = Você realmente deveria ter isso?

# From: _Shitmed/Body/Organs/generic.yml

ent-BioSynthEyes = olhos bio-sintéticos
    .desc = Estes olhos podem ser transplantados para qualquer organismo vivo e se adaptarão ao seu receptor.

ent-BioSynthHeart = coração bio-sintético
    .desc = Este coração pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthLiver = fígado bio-sintético
    .desc = Este fígado pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthLungs = pulmões bio-sintéticos
    .desc = Estes pulmões podem ser transplantados para qualquer organismo vivo e se adaptarão ao seu receptor.
...
ent-TailCarp = cauda de peixe-carpa
    .desc = Glândulas únicas nesta cauda permitem que peixes-carpa espaciais voem no vácuo.

ent-TorsoCarp = tronco de peixe-carpa
...
ent-TorsoMonkey = torso de macaco
...
ent-JawsOfLifeLeftArm = braço esquerdo J.W.L
    .desc = Um braço esquerdo cibernético com a capacidade de forçar portas abertas.

ent-JawsOfLifeRightArm = braço direito J.W.L
    .desc = Um braço direito cibernético com a capacidade de forçar portas abertas.
...
ent-BioSynthHeadEmpty = cabeça vazia bio-sintética
    .desc = Essa cabeça sintética pode ser transplantada para qualquer organismo vivo e se adaptará ao seu receptor, mas não contém um cérebro ou olhos.

ent-BioSynthLeftArm = braço esquerdo bio-sintético
    .desc = Este braço esquerdo pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthLeftFoot = pé esquerdo bio-sintético
    .desc = Este pé esquerdo pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthLeftHand = mão esquerda bio-sintética
    .desc = Essa mão esquerda pode ser transplantada para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthLeftLeg = perna esquerda bio-sintética
    .desc = Essa perna esquerda pode ser transplantada para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthRightArm = braço direito bio-sintético
    .desc = Este braço direito pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthRightFoot = pé direito bio-sintético
    .desc = Este pé direito pode ser transplantado para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthRightHand = mão direita bio-sintética
    .desc = Essa mão direita pode ser transplantada para qualquer organismo vivo e se adaptará ao seu receptor.

ent-BioSynthRightLeg = perna direita bio-sintética
    .desc = Essa perna direita pode ser transplantada para qualquer organismo vivo e se adaptará ao seu receptor.
...
ent-MeleeDebugBurner = queimador bang
    .suffix = DEBUG
...
ent-AutodocCircuitboard = placa de máquina de autodoc
    .desc = Um circuito impresso de máquina para um autodoc.

ent-OperatingTableCircuitboard = placa de máquina de mesa cirúrgica
    .desc = Um circuito impresso de máquina para uma mesa cirúrgica.
...
ent-AutodocSyndie = autodoc do Sindicato
    .desc = Uma máquina médica avançada para curar os feridos críticos. Essa tem uma pintura vermelha suspeita.
...
ent-CentCommSectoralConsole = console setorial do CentComm
    .desc = Use isso para incomodar capitães de todas as estações de uma vez.
...
ent-SurgeryCorticalBorerRemoval = Remover Perfurador Cortical
    .desc = Remoção da infestação do Perfurador Cortical do corpo.
...
ent-SurgeryTendWoundsBrute = Curar Feridas por Contusão

ent-SurgeryTendWoundsBurn = Curar Feridas por Queimadura
...
ent-SurgeryStepOpenOrganSlot = Escavar uma cavidade

ent-SurgeryStepPriseOpenBones = Abrir os ossos

ent-SurgeryStepRemoveCorticalBorer = Remover o Perfurador Cortical
