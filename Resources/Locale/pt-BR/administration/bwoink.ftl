...
bwoink-system-messages-being-relayed-to-discord =
    ...
    Problemas podem ser tratados sem resposta.

bwoink-system-introductory-message =
    Por favor, descreva o problema que você encontrou em detalhes. Assuma que o administrador do jogo que está resolvendo o problema não tem conhecimento direto do que ocorreu.
    Por favor, não peça eventos especiais ou punições para outros jogadores.
    Quaisquer bugs e outros problemas relacionados devem ser reportados através do Discord ou Github.
    Uso indevido deste sistema de mensagens pode resultar em ação disciplinar.
...
admin-ahelp-admin-only-tooltip = Se marcado, a mensagem não será visível para o jogador,
    mas será visível para outros admins e ainda será encaminhada para o Discord.
