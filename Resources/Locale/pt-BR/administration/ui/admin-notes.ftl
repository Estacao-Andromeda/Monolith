...
admin-notes-notsecret = Não secreta
...
admin-notes-message-seen = Vista
...
admin-note-editor-pop-out = Abrir em janela separada
admin-note-editor-secret = Secreta?
admin-note-editor-secret-tooltip = Marcar isso tornará a nota não visível pelo jogador
...
admin-note-editor-expiry-checkbox-tooltip = Marque isso para fazer expirar
...
admin-notes-new-message = Você recebeu uma mensagem de admin de {$admin}: {$message}
admin-notes-fallback-admin-name = [Sistema]

# Admin remarks
admin-remarks-command-description = Abre a página de observações de admin
admin-remarks-command-error = Observações de admin foram desabilitadas
admin-remarks-title = Observações de admin
