...
main-menu-join-public-server-button-tooltip = Não é possível conectar ao servidor público com uma build de debug.
main-menu-direct-connect-button = Conexão Direta
main-menu-lobby-button = Conectar & Ir para o Lobby
