markings-used = Marcações Usadas
markings-unused = Marcações Disponíveis
markings-add = Adicionar Marcação
markings-remove = Remover Marcação
...
markings-category-FacialHair = Barba/Bigode
