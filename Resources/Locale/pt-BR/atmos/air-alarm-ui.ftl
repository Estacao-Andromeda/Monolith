...
air-alarm-ui-mode-wide-filtering = Filtrando (amplo)
...
air-alarm-ui-scrubber-wide-net-label = RedeAmpla
...
air-alarm-ui-thresholds-upper-warning-bound = Aviso acima de
air-alarm-ui-thresholds-lower-warning-bound = Aviso abaixo de
