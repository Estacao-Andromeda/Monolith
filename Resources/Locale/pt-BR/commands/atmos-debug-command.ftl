...
cmd-atvrange-error-zero =escala cannot ser zero, como isto seria causa um divisão por zero em AtmosDebugOverlay.
...
cmd-atvmode-error-out-of-range =gás ID não parsable ou fora de alcance.
