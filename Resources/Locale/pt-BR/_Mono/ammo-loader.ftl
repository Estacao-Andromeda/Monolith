...
ammo-loader-flush-verb = Esvaziar
...
ammo-loader-flushed-to-artillery = Munição esvaziada para { $artillery }!
ammo-loader-transfer-failed-to-artillery = Falha ao transferir munição para { $artillery }!

# Portas de Conexão de Dispositivos
signal-port-name-ammo-loader-load = Carregar Munição
signal-port-description-ammo-loader-load = Transfere a munição carregada para a artilharia naval vinculada.

signal-port-name-space-artillery-load = Receber Munição
signal-port-description-space-artillery-load = Recebe munição de um carregador vinculado.
