reagent-name-celoxradine = celoxradina
reagent-desc-celoxradine = Um medicamento desenvolvido para ajudar trabalhadores em ambientes industriais a curar mais rapidamente de perigos incomuns do local de trabalho. Lento, mas multipropósito.

reagent-name-rhymatine = rimatina
reagent-desc-rhymatine = Um químico incomum para tratar dano celular, trocando dano celular por dano de frio e choque.

reagent-name-mesotaxinide = mesotaxinida
reagent-desc-mesotaxinide = Um químico refinado do Ambuzol+ capaz de curar grandes quantidades de dano tóxico facilmente. Pode dissolver formas de vida baseadas em Letoferol facilmente. Capaz de reverter mutações naturais de Letoferol.

reagent-name-mesophenerol = mesofenerol
...
reagent-desc-protoletoferol = Letoferol neutralizado via eletrólise. Usado como um precursor para os químicos para curá-lo. Está muito morto para fazer qualquer coisa com você agora.
