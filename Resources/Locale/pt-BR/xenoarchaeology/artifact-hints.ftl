...
artifact-effect-hint-environment = Disrupção ambiental
...
artifact-effect-hint-biochemical = Disrupção bioquímica
artifact-effect-hint-destruction = Destruição em toda a estação
artifact-effect-hint-gun = Acelerador de entidade pequeno
...
artifact-trigger-hint-water = Hidro-reativo
