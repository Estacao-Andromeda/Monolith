set-game-preset-command-description = Define o preset do jogo para o número especificado de próximas rodadas. Também pode exibir o título e descrição de outro preset no lobby para enganar os jogadores.
