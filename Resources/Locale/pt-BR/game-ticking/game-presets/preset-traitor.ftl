...
traitor-death-match-description = Todos são traidores. Todos querem uns aos outros mortos.
traitor-death-match-station-is-too-unsafe-announcement = A estação está muito insegura para continuar. Você tem um minuto.
